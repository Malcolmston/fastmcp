...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/fastmcp', initials: 'fm', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/fastmcp</span> — Model Context Protocol servers, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of jlowin/fastmcp</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/fastmcp" footer={footer}>
