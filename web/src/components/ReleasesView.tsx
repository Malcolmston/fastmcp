...
import { FASTMCP } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/fastmcp.
const RELEASE_LIBS: RelLib[] = [
  { name: FASTMCP.name, icon: FASTMCP.icon, accent: FASTMCP.accent, repo: ghrepo(FASTMCP), url: FASTMCP.repo },
];
