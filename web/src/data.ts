...
export const FASTMCP: Lib = {
  ...
  blurb:"A from-scratch, standard-library-only Go framework for building Model Context Protocol (MCP) servers. "+
    ...
    "plumbing, over stdio or Streamable HTTP. A faithful, idiomatic port of Python's FastMCP.",
  tags:["JSON-RPC 2.0","tools","resources","prompts","stdio","HTTP/SSE","reflected schemas"],
  features:[
